...
impl std::fmt::Display for Chain {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Chain::Astar => write!(f, "astar"),
            Chain::Acala => write!(f, "acala"),
            Chain::Phala => write!(f, "phala"),
            Chain::Interlay => write!(f, "interlay"),
            ...
            Chain::Starknet => write!(f, "starknet"),
...
impl std::str::FromStr for Chain {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "astar" | "astr" => Ok(Chain::Astar),
            "acala" | "aca" => Ok(Chain::Acala),
            "phala" | "pha" => Ok(Chain::Phala),
            "interlay" | "intr" => Ok(Chain::Interlay),
